...
export default {
	...
	theme: {
		...
		extend: {
			...
			fontSize: {
				'mega': ['var(--text-mega)', { lineHeight: '0.8', letterSpacing: '-0.04em' }],
				'hero': ['var(--text-hero)', { lineHeight: '0.9', letterSpacing: '-0.03em' }],
				'large': ['var(--text-large)', { lineHeight: '1', letterSpacing: '-0.02em' }],
			},
			colors: {
			...
			keyframes: {
				...
				'glow': {
					'0%, 100%': { textShadow: '0 0 20px hsla(45, 100%, 65%, 0.5)' },
					'50%': { textShadow: '0 0 40px hsla(45, 100%, 65%, 0.8)' }
				}
			},
			animation: {
